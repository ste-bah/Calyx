...
pub(crate) fn run(raw: &[String]) -> CliResult {
    ...
    println!(
        "partitioned_rrf_plan_remap_db from_cf_root={} from_plan_key={} source_value_sha256={} cf_root={} plan_key={} slot_count={} vault_root={} value_bytes={} value_sha256={} readback_matches={}",
