...
pub use self::dependence_bulk::{
    categorical_counts_host, copula_terms_host, histogram_counts_host, rank_pair_host,
};
...
pub use self::mic::mic_pair_host;
