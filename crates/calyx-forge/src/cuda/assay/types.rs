...
pub struct CudaDependenceStats {
...
#[derive(Clone, Debug, PartialEq)]
pub struct CudaHistogramCounts {
    pub x_counts: Vec<u64>,
    pub y_counts: Vec<u64>,
    pub joint_counts: Vec<u64>,
    pub stats: CudaDependenceStats,
}

#[derive(Clone, Debug, PartialEq)]
pub struct CudaCategoricalCounts {
    pub table: Vec<u64>,
    pub stats: CudaDependenceStats,
}

#[derive(Clone, Debug, PartialEq)]
pub struct CudaRankPair {
    pub x_ranks: Vec<f64>,
    pub y_ranks: Vec<f64>,
    pub x_tie_sizes: Vec<u32>,
    pub y_tie_sizes: Vec<u32>,
    pub concordant: u64,
    pub discordant: u64,
    pub stats: CudaDependenceStats,
}
...
#[derive(Clone, Debug, PartialEq)]
pub struct CudaCopulaTerms {
    pub x_tie_sizes: Vec<u32>,
    pub y_tie_sizes: Vec<u32>,
    pub c_mid_count: u64,
    pub lower_tail_count: u64,
    pub upper_tail_count: u64,
    pub hoeffding_terms: Vec<f64>,
    pub gini_terms: Vec<f64>,
    pub stats: CudaDependenceStats,
}

#[derive(Clone, Copy, Debug, Default, PartialEq)]
pub struct CudaMicScan {
    pub score: f64,
    pub primary_bins: usize,
    pub secondary_bins: usize,
}

#[derive(Clone, Debug, PartialEq)]
pub struct CudaMicPair {
    pub primary_x: CudaMicScan,
    pub primary_y: CudaMicScan,
    pub stats: CudaDependenceStats,
}
